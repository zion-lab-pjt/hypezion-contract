# HypeZion Protocol - Smart Contracts

This directory contains all smart contract code for the HypeZion Protocol on HyperEVM.
...
- **Token System**: ERC20 compliant hzUSD and hzHYPE tokens
...
- **Protocol Intervention**: Automatic hzUSD to hzHYPE conversion when CR < 130%
